...
namespace ProductionServiceSystem.services.Implementations
{
    public class ShowResultService : IShowResultService
    {
        ...
        public ShowResultService(ISearchHistoryService searchHistoryService,
        ...
        public ResultCostDTO PresentResult(string cityName, ModuleListDTO moduleListDTO)
        {
            ...
            try
            {
                calculateCost = (OperationSuccesDTO<ResultCostDTO>)_calculatorCostService.CalculateCost(cityName, moduleListDTO);
            }
            catch
            {
